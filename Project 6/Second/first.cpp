...
#ifndef NMB
#define	NMB			8192		// 2 4 8 16 32 64 128 256 512 1024 2048	4096			
#endif

#define NUM_ELEMENTS		NMB*1024

#ifndef LOCAL_SIZE
#define	LOCAL_SIZE		512		//8 16 32 64 128 256 512 
#endif
...
main( int argc, char *argv[ ] )
{
	...
	float *hD = new float[ NUM_ELEMENTS ];    			//problem 2
...
*/
	fprintf( stderr, "NUM_ELEMENTS:%8d\tLOCAL_SIZE:%4d\tNUM_WORK_GROUPS:%10d\t%10.3lf GigaMultsPerSecond\n",
